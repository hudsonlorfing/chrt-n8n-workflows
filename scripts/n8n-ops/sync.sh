...
# Workflow files mapping (v2 split workflows)
FILE_SYNC="workflows/chrt-github-workflow-sync.json"
FILE_INGESTION="workflows/linkedin/1.0-lead-ingestion-icp-scoring.json"
FILE_OUTREACH_SEND="workflows/linkedin/2.1-linkedin-outreach-send.json"
FILE_OUTREACH_RESULTS="workflows/linkedin/2.2-linkedin-outreach-results.json"
FILE_CONN_LAUNCH="workflows/linkedin/3.1-connection-sync-launch.json"
FILE_CONN_PROCESS="workflows/linkedin/3.2-connection-sync-process.json"
FILE_CONN_HUBSPOT="workflows/linkedin/3.3-connection-sync-hubspot.json"
FILE_PIPELINE_LAUNCH="workflows/linkedin/4.1-pipeline-monitor-launch.json"
FILE_PIPELINE_RESULTS="workflows/linkedin/4.2-pipeline-monitor-results.json"
